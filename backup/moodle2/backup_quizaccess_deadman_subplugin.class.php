...
/**
 * Backup helper functions for the quizaccess_deadman plugin.
 *
 ...
 * @license   https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_quizaccess_deadman_subplugin extends backup_mod_quiz_access_subplugin {
    #[\Override]
    protected function define_quiz_subplugin_structure() {
        ...
        $subpluginsettings = new backup_nested_element('quizaccess_deadman', null, ['enable', 'warningtext']);
        $subpluginsettings->set_source_table('quizaccess_deadman', ['quizid' => $quizid]);
